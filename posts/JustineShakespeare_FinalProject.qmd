---
title: "From Christopher to Oliver: Exploring Generational Shifts in Baby Name Data"
author: "Justine Shakespeare"
description: "Final project submission for DACSS 601: Data Science Fundamentals. Performed exploratory data analysis and data visualization to analyse patterns and trends in data on baby names in the US from 1880 to 2021"
date: "05/22/2023"
format:
  html:
    df-print: paged
...
Compared to decisions about sleep, breastfeeding, schools, and more, choosing a baby's name may seem like one of the more arbitrary and inconsequential choices a parent makes. But it is a deeply personal decision, shaped by expectations, hopes, and even whimsy. While baby names may appear to be a lighthearted data point, they offer a fascinating window into cultural trends and societal values in the United States over time.

My interest in baby names and naming trends is personally motivated. The day we found out I was pregnant in the spring of 2020, my husband suggested the name Oliver if we had a boy. I loved it---but soon discovered we weren't alone. In 2020, Oliver was the third most popular name for baby boys in the United States.

I thought back to my childhood in rural Vermont, where four out of the 16 kids in my elementary school class were named Chris. I didn't want my son to be one of four Olivers in his classroom. As we searched for alternative names, a friend pointed out that while Oliver is popular now---just as Chris was in the mid-1980s---the actual percentage of babies given the name might be lower than it was for Chris in the 1980s. This is because the diversity of names has increased over time---today, parents are choosing from a much wider pool of names, so even top-ranked names are given to a smaller share of babies than in previous generations. When I found data on baby names, I knew I had to investigate this hypothesis.

In addition to answering this burning question, I will explore other patterns around name popularity, including which names have been the most popular during different time periods, and whether there is a cyclical nature to popularity of some names.

## Dataset Introduction

The data I'll be analyzing was downloaded from the [Social Security Administration (SSA) website](https://www.ssa.gov/oact/babynames/limits.html). It includes all of the names in the SSA database, which are drawn from Social Security card applications for babies born in the United States from 1880 until 2021. This analysis goes beyond what is featured on the SSA website, which is limited to just the top 1,000 names for each year and sex. The data that will be used in this analysis includes all names between 1880 and 2021 with some stipulations (see below).
